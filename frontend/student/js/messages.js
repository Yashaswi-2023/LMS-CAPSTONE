!(function (t) {
        ...
        splice: function (t, e) {
          ...
          if (
            (0 === y
              ...
              : 1 === y
              ? ((n = 0), (r = m - x))
              : ((n = y - 2), (r = v(g(i(e), 0), m - x))),
            m + n - r > 9007199254740991)
          )
            throw TypeError("Maximum allowed length exceeded");
          for (l = s(h, r), f = 0; f < r; f++)
            (p = x + f) in h && u(l, f, h[p]);
          if (((l.length = r), n < r)) {
            for (f = x; f < m - r; f++)
              (d = f + n), (p = f + r) in h ? (h[d] = h[p]) : delete h[d];
            for (f = m; f > m - r + n; f--) delete h[f - 1];
          } else if (n > r)
            for (f = m - r; f > x; f--)
              (d = f + n - 1),
                (p = f + r - 1) in h ? (h[d] = h[p]) : delete h[d];
      ...
      { target: "Array", proto: !0, forced: !d || !g },
      {
        slice: function (t, e) {
          ...
          if (
            ...
            return h.call(f, d, g);
          for (
            r = new (void 0 === n ? Array : n)(m(g - d, 0)), l = 0;
            d < g;
            d++, l++
          )
            d in f && u(r, l, f[d]);
        ...
        var t = n(463),
          e = function () {
            var t = document.querySelector(
              ".app-messages__container [data-perfect-scrollbar]"
            );
    ...
    !(function (i, a) {
        ...
        H = {
          template: {
            compile: function t(n, r, o, i) {
              function a(r) {
                ...
                if ("" + r === r || (r.nodeType > 0 && (s = r))) {
                  if (!s)
                    ...
                    else if (e.fn && !v.rTmpl.test(r))
                      try {
                        s = e(r, document)[0];
                      } catch (t) {}
                  s &&
                    ("SCRIPT" !== s.tagName &&
                      xt(r + ": Use script block, not " + s.tagName),
                    i
                      ? (r = s.innerHTML)
                      : ((a = s.getAttribute("data-jsv-tmpl")) &&
                          ("jsvTmpl" !== a
                            ? ((r = f[a]), delete f[a])
                            : e.fn && (r = e.data(s).jsvTmpl)),
                        (a && r) ||
                          ((n = n || (e.fn ? "jsvTmpl" : r)),
                          (r = t(n, s.innerHTML, o, i))),
                        (r.tmplName = n = n || a),
                        "jsvTmpl" !== n && (f[n] = r),
                        s.setAttribute("data-jsv-tmpl", n),
                        e.fn && e.data(s, "jsvTmpl", r))),
                    (s = void 0);
                } else r.fn || (r = void 0);
                return r;
              }
              ...
              ((i = i || (r.markup ? (r.bnds ? et({}, r) : r) : {})).tmplName =
                i.tmplName || n || "unnamed"),
                o && (i._parentTmpl = o);
          ...
          tag: {
            compile: function (t, e, n) {
              ...
              u(e)
                ...
                : "" + e === e && (e = { template: e });
              if ((o = e.baseTag))
                for (i in ((e.flow = !!e.flow),
                (o = "" + o === o ? (n && n.tags[o]) || g[o] : o) ||
                  xt('baseTag: "' + e.baseTag + '" not found'),
                (a = et(a, o)),
                e))
                  a[i] = Q(o[i], e[i]);
              else a = et(a, e);
              void 0 !== (r = a.template) &&
                (a.template = "" + r === r ? f[r] || f(r) : r);
              ((c.prototype = a).constructor = a._ctr = c),
                n && (a._parentTmpl = n);
              return a;
            },
          },
          viewModel: {
            compile: function (t, n) {
              var r,
                ...
                f = n.extend,
                p = n.id,
                d = e.extend({ _is: t || "unnamed", unmap: S, merge: w }, f),
                g = "",
                v = "",
                h = c ? c.length : 0,
                m = e.observable,
              ...
              function _(t, e) {
                for (var n, r, o, i, s, u = 0; u < h; u++)
                  (n = void 0),
                    (o = c[u]) + "" !== o &&
                      ((o = (n = o).getter), (s = n.parentRef)),
                    void 0 === (i = t[o]) &&
                      n &&
              ...
              function w(t, e, n) {
                ...
                if (l(y)) {
                  for (f = {}, g = [], o = t.length, i = y.length; h < o; h++) {
                    ...
                    u
                      ? (c.merge(d), g.push(c))
                      : (g.push((v = b.map(d))), n && ft(v, n, e));
                  }
                  m
                    ? m(y).refresh(g, !0)
                    : y.splice.apply(y, [0, y.length].concat(g));
                } else
              ...
              function S() {
                ...
                for (t = {}; o < h; o++)
                  (n = void 0),
                    (e = c[o]) + "" !== e && (e = (n = e).getter),
                    (r = this[e]()),
                    (t[e] =
                      n && r && a[n.type] ? (l(r) ? i(r) : r.unmap()) : r);
                for (e in this)
                  !this.hasOwnProperty(e) ||
                    ("_" === e.charAt(0) && x[e.slice(1)]) ||
                    e === s ||
                    u(this[e]) ||
                    (t[e] = this[e]);
                return t;
              }
              for (y.prototype = d, r = 0; r < h; r++)
                !(function (t) {
              ...
              return (
                ...
                ((o = function () {
                  v.apply(this, arguments),
                    (i = arguments[h + 1]) && ft(this, arguments[h], i);
                }).prototype = d),
                (d.constructor = o),
                (b.map = function (e) {
                  ...
                  if (e) {
                    for (
                      ...
                      if (((o = f[a]), (i = c[a].parentRef) && o && o.unmap))
                        if (l(o)) for (n = o.length; n--; ) ft(o[n], i, u);
                        else ft(o, i, u);
      ...
      function W(t, e) {
        ...
        for (n in r)
          !M.test(n) ||
            (t[n] && t[n].fix) ||
            (t[n] =
              "convert" !== n ? Q(t.constructor.prototype[n], r[n]) : r[n]);
      }
      function X(t) {
        return t;
      }
      ...
      function ot(t, e, n, r) {
        ...
        if ((1 === n && ((r = 1), (n = void 0)), e))
          for (a = (i = e.split(".")).length; t && c < a; c++)
            (o = t), (t = i[c] ? t[i[c]] : t);
        return (
          n && (n.lt = n.lt || c < a),
          void 0 === t
      ...
      function it(n, r, o) {
        ...
        if (n) {
          if (
            (g._ || ((l = g.index), (g = g.tag)),
            (f = g),
            (m && m.hasOwnProperty(n)) || (m = d).hasOwnProperty(n))
          ) {
            if (
              ((c = m[n]),
              "tag" === n ||
          ...
          if (
            ...
            ((c && c._cxp) ||
              ((g =
                g.tagCtx || u(c)
                  ? g
                  : (!(g = g.scope || g).isTop && g.ctx.tag) || g),
              void 0 !== c && g.tagCtx && (g = g.tagCtx.view.scope),
              (m = g._ocps),
              ((c = (m && m.hasOwnProperty(n) && m[n]) || c) && c._cxp) ||
                (!o && !h) ||
                (((m || (g._ocps = g._ocps || {}))[n] = c =
                  [{ _ocp: c, _vw: f, _key: n }]),
                (c._cxp = {
                  path: "_ocp",
                  ind: 0,
            ...
            if (arguments.length > 2)
              return (
                (a = c[1] ? v._ceo(c[1].deps) : ["_ocp"]).unshift(c[0]),
                (a._cxp = s),
                a
              );
            if (
              ...
              (p = c[1]
                ? s.tag && s.tag.cvtArgs
                  ? s.tag.cvtArgs(l, 1)[s.ind]
                  : c[1](c[0].data, c[0], v)
                : c[0]._ocp),
              h)
            )
              return v._ucp(n, r, g, s), g;
            c = p;
          }
          return (
            c &&
      ...
      function at(t, e) {
        ...
        if (
          ...
          (s = c.convert) &&
            ...
            (s =
              "true" === s
                ? void 0
                : u.view.getRsc("converters", s) ||
                  xt("Unknown converter: '" + s + "'")),
          s && !e && (i = i.slice()),
          a)
        ) {
        ...
        if (s) {
          ...
          if (
            ((n = (a = a || [0]).length),
            (l(s) &&
              (!1 === s.arg0 || (1 !== n && s.length === n && !s.arg0))) ||
              ((s = [s]), (a = [0]), (n = 1)),
            e)
          )
            i = s;
          else for (; n--; ) +(r = a[n]) === r && (i[r] = s[n]);
        }
        return i;
      }
      function ct(t, e) {
      ...
      function ut(t, e, n, r, o, i, a, c) {
        ...
        (this.content = c),
          ...
          (this.tmpl = o),
          (l = this._ =
            { key: 0, useKey: f ? 0 : 1, id: "" + V++, onRender: a, bnds: {} }),
          (this.linked = !!a),
          (this.type = e || "top"),
          ...
          (this.parent = n)
            ? ((this.root = n.root || this),
              ...
              (this.isTop = u.scp),
              (this.scope =
                ((!t.tag || t.tag === n.ctx.tag) && !this.isTop && n.scope) ||
                this),
              u.useKey
                ? ((s[(l.key = "_" + u.useKey++)] = this),
                  (this.index = K),
                  (this.getIndex = nt))
                : s.length === (l.key = this.index = i)
                ? s.push(this)
                : s.splice(i, 0, this),
              (this.ctx = t || n.ctx))
            : e && (this.root = this);
      ...
      function pt(t, n) {
        var r,
          o = m._wm || {},
          i = { tmpls: [], links: {}, bnds: [], _is: "template", render: ht };
        return (
          n && (i = et(i, n)),
          (i.markup = t),
          i.htmlTag ||
            ((r = k.exec(t)), (i.htmlTag = r ? r[1].toLowerCase() : "")),
          (r = o[i.htmlTag]) && r !== o.div && (i.markup = e.trim(i.markup)),
          i
        );
      }
      function dt(t, e) {
        ...
        c[n] = function r(i, a, s) {
          ...
          return (
            i && "" + i !== i && ((s = a), (a = i), (i = void 0)),
            (f = s ? ("viewModel" === t ? s : (s[n] = s[n] || {})) : r),
            (u = e.compile),
            void 0 === a && ((a = u ? i : f[i]), (i = void 0)),
            null === a
              ? i && delete f[i]
              : (u && ((a = u.call(f, i, a, s, 0) || {})._is = t),
                i && (f[i] = a)),
            p && p(i, a, s, u),
            a
          );
      ...
      function ht(t, e, n, r, i, c) {
        ...
        if (
          ...
          (p = this.tag)
            ? ((g = this),
              (d = (b = b || g.view)._getTmpl(p.template || g.tmpl)),
              arguments.length ||
                (t =
                  p.contentCtx && u(p.contentCtx) ? (t = p.contentCtx(t)) : b))
            : (d = this),
          d)
        ) {
          if (
            ...
            (j = j || h),
            h && ((e = e || {}).root = t),
            !j || m.useViews || d.useViews || (b && b !== a))
          )
            _ = mt(d, t, e, n, b, i, c, p);
          else {
            if (
              (b
                ? ((x = b.data), (y = b.index), (b.index = K))
                : ((x = (b = a).data), (b.data = t), (b.ctx = e)),
              l(t) && !n)
            )
              for (s = 0, f = t.length; s < f; s++)
                (b.index = s), (b.data = t[s]), (_ += d.fn(t[s], b, v));
      ...
      function mt(t, e, n, r, o, i, a, c) {
        ...
        if (
          (c &&
            ((x = c.tagName),
            (_ = c.tagCtx),
            (n = n ? jt(n, c.ctx) : c.ctx),
            t === o.content
              ? (h = t !== o.ctx._wrp ? o.ctx._wrp : void 0)
              : t !== _.content
              ? t === c.template
                ? ((h = _.tmpl), (n._wrp = _.content))
                : (h = _.content || o.content)
              : (h = o.content),
            !1 === _.props.link && ((n = n || {}).link = !1)),
          o &&
            ((a = a || o._.onRender),
            (w = n && !1 === n.link) && o._.nl && (a = void 0),
            (n = jt(n, o.ctx)),
            (_ = !c && o.tag ? o.tag.tagCtxs[o.tagElse] : _)),
          (y = _ && _.props.itemVar) &&
            ("~" !== y[0] && yt("Use itemVar='~myItem'"), (y = y.slice(1))),
          !0 === i && ((g = !0), (i = 0)),
          a && c && c._.noVws && (a = void 0),
          (m = a),
          !0 === a && ((m = void 0), (a = o._.onRender)),
          (b = n = t.helpers ? jt(t.helpers, n) : n),
          l(e) && !r)
        )
          for (
            (f = g
              ? o
              : (void 0 !== i && o) ||
                new ut(n, "array", o, e, t, i, a, h))._.nl = w,
              o &&
                o._.useKey &&
                ((f._.bnd = !c || (c._.bnd && c)), (f.tag = c)),
              s = 0,
              u = e.length;
            s < u;
            s++
          )
            (p = new ut(b, "item", f, e[s], t, (i || 0) + s, a, f.content)),
              y && ((p.ctx = et({}, b))[y] = v._cp(e[s], "#data", p)),
              (d = t.fn(e[s], p, v)),
              (S += f._.onRender ? f._.onRender(d, p) : d);
        else
          (f = g ? o : new ut(b, x || "data", o, e, t, i, a, h)),
            y && ((f.ctx = et({}, b))[y] = v._cp(e, "#data", f)),
            (f.tag = c),
            (f._.nl = w),
            (S += t.fn(e, f, v));
        return (
          c && ((f.tagElse = _.index), (_.contentView = f)), m ? m(S, f) : S
        );
      }
      function xt(t) {
        throw new v.Err(t);
      ...
      function bt(t, e, n, r, o) {
        ...
        var s,
          ...
          f,
          p,
          d = h.allowCode || (e && e.allowCode) || !0 === x.allowCode,
          g = [],
          v = 0,
          m = [],
          b = g,
          S = [, , g];
        if (
          (d && e._is && (e.allowCode = d),
          n &&
            (void 0 !== r && (t = t.slice(0, -r.length - 2) + _),
            (t = y + t + w)),
          c(m[0] && m[0][2].pop()[0]),
          t.replace(i, function (i, s, u, p, g, h, x, y, _, w, E, j) {
            ((x && s) || (_ && !u) || (y && ":" === y.slice(-1)) || w) && yt(i),
              h && ((g = ":"), (p = "html"));
            var C,
              A,
              k,
            ...
            (u = u || ((y = y || "#data"), g)),
              ...
              x
                ...
                ? ("else" === u &&
                    (P.test(y) &&
                      yt('For "{{else if expr}}" use "{{else expr}}"'),
                    (I = S[9] && [[]]),
                    (S[10] = t.substring(S[10], j)),
                    (A = S[11] || S[0] || yt("Mismatched: " + i)),
                    (S = m.pop()),
                    (b = S[2]),
                    (K = !0)),
                  y &&
                    St(y.replace(O, " "), I, e, n)
                      .replace(R, function (t, e, n, r, o, i, a, c) {
                        return (
                          "this:" === r && (i = "undefined"),
                          c && (k = k || "@" === c[0]),
                          (r = "'" + o + "':"),
                  ...
                  b.push(l),
                  K && (m.push(S), ((S = l)[10] = v), (S[11] = A)))
                : E &&
                  (c(E !== S[0] && E !== S[11] && E, S[0]),
                  (S[10] = t.substring(S[10], j)),
                  (S = m.pop())),
              c(!S && E),
              (b = S[2]);
          ...
          a(t.length),
          (v = g[g.length - 1]) && c("" + v !== v && +v[10] === v[10] && v[0]),
          n)
        ) {
            ...
            function (
              ...
              if (!u && !s) {
                if ((P && yt(t), L && l)) {
                  if (((G = w[h - 1]), J.length - 1 > tt - (G || 0))) {
                    if (
                      ((G = e.trim(J.slice(G, tt + r.length))),
                      (H = a || p[h - 1].bd),
                      (Y = H[H.length - 1]) && Y.prm)
                    ) {
                      for (; Y.sb && Y.sb.prm; ) Y = Y.sb;
                      Q = Y.sb = { path: Y.sb, bnd: Y.bnd };
                    } else H.push((Q = { path: H.pop() }));
                    Y &&
                      Y.sb === Q &&
                      ((E[h] = E[h - 1].slice(Y._cpPthSt) + E[h]),
                      (E[h - 1] = E[h - 1].slice(0, Y._cpPthSt))),
                      (Q._cpPthSt = S[h - 1]),
                      (Q._cpKey = G),
                      (E[h] += J.slice(j, z)),
                      (j = z),
                      ...
                      (E[h - 1] +=
                        _[g] && m.cache
                          ? 'view.getCache("' + G.replace(A, "\\$&") + '"'
                          : E[h]),
                      (Q.prm = f.bd),
                      (Q.bnd = Q.bnd || (Q.path && Q.path.indexOf("^") >= 0));
                  }
                  E[h] = "";
                }
                "[" === N && (N = "[j._sq("), "[" === C && (C = "[j._sq(");
              ...
              return (
                (Z = u
                  ...
                  : (C
                    ...
                    (K
                      ...
                      ? T.split("^")
                          .join(".")
                          .replace(v.rPath, function (t, e, r, c, s, u, p, d) {
                            if (
                              ((W = "." === r),
                              r &&
                                ((T = T.slice(e.length)),
                                /^\.?constructor$/.test(d || T) && yt(t),
                                W ||
                                  ((t =
                                    (M
                                      ? (o ? "" : "(ltOb.lt=ltOb.lt||") + "(ob="
                                      : "") +
                                    (c
                                      ? 'view.ctxPrm("' + c + '")'
                                      : s
                ...
                l &&
                  ...
                  u ||
                    s ||
                    ((X = C && b[g + 1]) && ((E[h - 1] += C), S[h - 1]++),
                    "(" === N &&
                      W &&
                      !Q &&
                      ((E[h] = E[h - 1].slice(y) + E[h]),
                      (E[h - 1] = E[h - 1].slice(0, y)))),
                  (E[h] += X ? Z.slice(1) : Z)),
                u || s || !N || (g++, T && "(" === N && (_[g] = !0)),
                u || s || !q || (l && (E[h] += N), (Z += N)),
                Z
      ...
      function Et(t, e, n) {
        ...
        for (
          "" + e === e
            ? ((w = n
                ? 'data-link="' + e.replace(O, " ").slice(1, -1) + '"'
                : e),
              (e = 0))
            : ((w = e.tmplName || "unnamed"),
              e.allowCode && (z.allowCode = !0),
              e.debug && (z.debug = !0),
              (p = e.bnds),
              (_ = e.tmpls)),
            r = 0;
            ...
            if (
              ...
              o[8]
                ? ((D = "\nvar ob,ltOb={},ctxs="),
                  (U = ";\nctxs.lt=ltOb.lt;\nreturn ctxs;"))
                : ((D = "\nreturn "), (U = "")),
              (C = o[10] && o[10].replace(T, "$1")),
              (P = "else" === i)
                ? d && d.push(o[9])
                : ((M = o[5] || (!1 !== h.debugMode && "undefined")),
                  p && (d = o[9]) && ((d = [d]), (q = p.push(1)))),
              (K = K || v[1] || v[2] || d || /view.(?!index)/.test(v[0])),
              (k = ":" === i)
                ? a && (i = "html" === a ? ">" : a + i)
                : (j &&
                    (((S = pt(C, z)).tmplName = w + "/" + i),
                    (S.useViews = S.useViews || K),
                    Et(j, S),
                    (K = S.useViews),
                    _.push(S)),
                  P ||
      ...
      function Ct(t, n) {
        ...
        if (
          (d || (p && "" + p === p)
            ...
            : (p || v < 0) && !a.dataMap && (t = t.slice()),
          u(p) &&
            (t = t.sort(function () {
              return p.apply(n, arguments);
            })),
          v < 0 && (!p || u(p)) && (t = t.reverse()),
          t.filter &&
            f &&
            ((t = t.filter(f, n)), n.tag.onFilter && n.tag.onFilter(n)),
          s.sorted &&
            ((r = p || v < 0 ? t : t.slice()),
            a.sorted ? e.observable(a.sorted).refresh(r) : (n.map.sorted = r)),
          (o = c.start),
          (i = c.end),
          ((s.start && void 0 === o) || (s.end && void 0 === i)) && (o = i = 0),
          (isNaN(o) && isNaN(i)) ||
            ((o = +o || 0),
            (i = void 0 === i || i > t.length ? t.length : +i),
            (t = t.slice(o, i))),
          g > 1)
        ) {
      ...
      if (
        ((c = {
          ...
          sub: {
            ...
            _cnvt: function (t, e, n, r) {
              ...
              if (((u = u._bd && u), t || u)) {
                if (((i = e._lc), (o = i && i.tag), (n.view = e), !o)) {
                  ...
                  i && ((i.tag = o), (o.linkCtx = i)),
                    (n.ctx = jt(n.ctx, (i ? i.view : e).ctx)),
                    W(o, n);
                }
                (o._er = r && a),
                  (o.ctx = n.ctx || o.ctx || {}),
              ...
              return null != (a = u && e._.onRender ? e._.onRender(a, e, o) : a)
                ? a
                : "";
            },
            _tag: function (t, e, n, r, o, i) {
              function c(t) {
                var e = s[t];
                if (void 0 !== e)
                  for (e = l(e) ? e : [e], m = e.length; m--; )
                    ($ = e[m]), isNaN(parseInt($)) || (e[m] = parseInt($));
                return e || [0];
              }
              var s,
                u,
              ...
              "tag" === t._is
                ? ((t = (s = t).tagName), (r = s.tagCtxs), s.template)
                : ((u =
                    e.getRsc("tags", t) || xt("Unknown tag: {{" + t + "}} ")),
                  u.template);
              void 0 === i &&
                J &&
                (J._lr = (u.lateRender && !1 !== J._lr) || J._lr) &&
                (i = "");
              void 0 !== i
                ? ((q += i),
                  (r = i = [{ props: {}, args: [], params: { props: {} } }]))
                : J && (r = J(e.data, e, v));
              for (h = r.length; L < h; L++)
                (b = r[L]),
                  ...
                  (!K ||
                    ...
                    s._er ||
                    (C && +C === C)) &&
                    (C && z.tmpls && (b.tmpl = b.content = z.tmpls[C - 1]),
                    (b.index = L),
                    (b.ctxPrm = it),
                    (b.render = ht),
                    (b.cvtArgs = at),
                  ...
                  s
                    ...
                    : ((s = new u._ctr()),
                      ...
                      (s.parent = g = B && B.tag),
                      (s.tagCtxs = r),
                      K && ((s.inline = !1), (K.tag = s)),
                      (s.linkCtx = K),
                      (s._.bnd = J || K.fn)
                        ? ((s._.ths = b.params.props.this),
                          (s._.lt = r.lt),
                          (s._.arrVws = {}))
                        : s.dataBoundOnly &&
                          xt(t + " must be data-bound:\n{^{" + t + "}}")),
                  (I = s.dataMap),
                  (b.tag = s),
                  I && r && (b.map = r[L].map),
                  s.flow ||
                    ...
                    (f =
                      s.parents =
                      _.parentTags =
                        (B && jt(_.parentTags, B.parentTags)) || {}),
                    g && (f[g.tagName] = g),
                    (f[s.tagName] = _.tag = s),
                    (_.tagCtx = b));
              if (!(s._er = i)) {
                for (
                  W(s, r[0]), s.rendering = { rndr: s.rendering }, L = 0;
                  L < h;
                  L++
                ) {
                  if (
                    ((b = s.tagCtx = r[L]), (k = b.props), (s.ctx = b.ctx), !L)
                  ) {
                    if (
                      (O && (s.init(b, K, s.ctx), (O = void 0)),
                      b.args.length ||
                        !1 === b.argDefault ||
                        !1 === s.argDefault ||
                        ((b.args = R = [b.view.data]),
                        (b.params.args = ["#data"])),
                      (S = c("bindTo")),
                      void 0 !== s.bindTo && (s.bindTo = S),
                      void 0 !== s.bindFrom
                        ? (s.bindFrom = c("bindFrom"))
                        : s.bindTo && (s.bindFrom = s.bindTo = S),
                      (E = s.bindFrom || S),
                      (D = S.length),
                      (F = E.length),
                      s._.bnd &&
                        (U = s.linkedElement) &&
                        ((s.linkedElement = U = l(U) ? U : [U]),
                        D !== U.length &&
                          xt("linkedElement not same length as bindTo")),
                      (U = s.linkedCtxParam) &&
                        ((s.linkedCtxParam = U = l(U) ? U : [U]),
                        F !== U.length &&
                          xt(
                      ...
                      for (s._.fromIndex = {}, s._.toIndex = {}, x = F; x--; )
                        for ($ = E[x], m = D; m--; )
                          $ === S[m] &&
                            ((s._.fromIndex[m] = x), (s._.toIndex[x] = m));
                    K && (K.attr = s.attr = K.attr || s.attr || K._dfAt),
                      (d = s.attr),
                      (s._.noVws = d && "html" !== d);
                  }
                  if (((R = s.cvtArgs(L)), s.linkedCtxParam))
                    for (
                      P = s.cvtArgs(L, 1),
                        m = F,
                        V = s.constructor.prototype.ctx;
                      m--;

                    )
                      (w = s.linkedCtxParam[m]) &&
                        (($ = E[m]),
                        (j = P[m]),
                        (b.ctx[w] = v._cp(
                          V && void 0 === j ? V[w] : j,
                          void 0 !== j && ct(b.params, $),
                          b.view,
                          s._.bnd && {
                            tag: s,
                            cvt: s.convert,
                  ...
                  (T = k.dataMap || I) &&
                    ...
                    (((A = b.map) && A.src === R[0] && !o) ||
                      (A && A.src && A.unmap(),
                      T.map(R[0], b, A, !s._.bnd),
                      (A = b.map)),
                    (R = [A.tgt])),
                    (y = void 0),
                    s.render &&
                      ((y = s.render.apply(s, R)),
                      e.linked &&
                        y &&
                        !N.test(y) &&
                        (((n = { links: [] }).render = n.fn =
                        ...
                        (y = mt(n, e.data, void 0, !0, e, void 0, void 0, s)))),
                    R.length || (R = [e]),
                    void 0 === y &&
                      ((M = R[0]),
                      s.contentCtx &&
                        (M = !0 === s.contentCtx ? e : s.contentCtx(M)),
                      (y = b.render(M, !0) || (o ? void 0 : ""))),
                    (q = q ? q + (y || "") : void 0 !== y ? "" + y : void 0);
                }
                s.rendering = s.rendering.rndr;
              }
              (s.tagCtx = r[0]),
                (s.ctx = s.tagCtx.ctx),
                s._.noVws && s.inline && (q = "text" === d ? p.html(q) : "");
            ...
            _err: function (t, e, n) {
              var r =
                void 0 !== n
                  ...
                  : "{Error: " + (t.message || t) + "}";
              h.onError &&
                void 0 !== (n = h.onError.call(e.data, t, n && r, e)) &&
                (r = n);
          ...
          settings: {
            delimiters: function t(e, n, r) {
              ...
              (S = r ? r[0] : S),
                /^(\W|_){5}$/.test(e + n + S) || xt("Invalid delimiters");
              return (
                (y = e[0]),
                (b = e[1]),
                (_ = n[0]),
                (w = n[1]),
                (h.delimiters = [y + b, _ + w, S]),
                (e = "\\" + y + "(\\" + S + ")?\\" + b),
                (n = "\\" + _ + "\\" + w),
                (i =
                  "(?:(\\w+(?=[\\/\\s\\" +
        ...
        (ut.prototype = {
          ...
          getRsc: function (t, e) {
            ...
            if ("" + e === e) {
              for (; void 0 === n && o; )
                (n = (r = o.tmpl && o.tmpl[t]) && r[e]), (o = o.parent);
              return n || c[t][e];
            }
          },
          _getTmpl: function (t) {
          ...
          getCache: function (t) {
            return (
              h._cchCt > this.cache._ct && (this.cache = { _ct: h._cchCt }),
              void 0 !== this.cache[t]
                ? this.cache[t]
                : (this.cache[t] = B[t](this.data, this, v))
            );
          },
          _is: "view",
        }),
        ...
        if (
          ...
          if (((e.fn.render = Ot), (s = e.expando), e.observable)) {
            if (C !== (C = e.views.jsviews))
              throw "jquery.observable.js requires jsrender.js " + C;
          ...
          (e = {}),
            ...
            (e.jsrender = C);
        for (E in (((h = v.settings).allowCode = !1),
        (u = e.isFunction),
        (e.render = z),
        (e.views = c),
        (e.templates = f = c.templates),
        h))
          gt(E);
        (x.debugMode = function (t) {
          ...
          (m = h.advanced = { cache: !0, useViews: !1, _jsv: !1 }),
          g({
            if: {
              render: function (t) {
                var e = this.tagCtx;
            ...
            for: {
              ...
              render: function (t) {
                ...
                if (!this.rendering.done) {
                  ...
                  void 0 !== e &&
                    ((n = l(e)),
                    (f += a.render(e, !u || s.noIteration)),
                    (p += n ? e.length : 1)),
                    (this.rendering.done = p) && (this.selected = a.index);
                }
                return f;
              },
                  ...
                  if (((c = []), "object" === o(t) || u(t)))
                    for (r in t)
                      (i = t[r]),
                        r === s ||
                          !t.hasOwnProperty(r) ||
                          (n.props.noFunctions && e.isFunction(i)) ||
                          c.push({ key: r, prop: i });
            ...
            dbg:
              (d.dbg = p.dbg =
                function (t) {
                  try {
                    throw (
                      (console.log("JsRender dbg breakpoint: " + t),
                      "dbg breakpoint")
                    );
                  } catch (t) {}
  ...
  54: function (t, e, n) {
    ...
    r("replace", 2, function (t, e, n, r) {
      ...
      return [
        ...
        function (t, r) {
          if ((!d && g) || ("string" == typeof r && -1 === r.indexOf(v))) {
            var c = n(e, t, this, r);
          ...
          for (var _ = []; ; ) {
            ...
            if (null === w) break;
            if ((_.push(w), !y)) break;
            "" === String(w[0]) && (h.lastIndex = s(m, i(h.lastIndex), b));
          }
          for (var S, E = "", j = 0, C = 0; C < _.length; C++) {
            w = _[C];
            for (
              var O = String(w[0]),
                T = f(p(a(w.index), m.length), 0),
                A = [],
                R = 1;
              R < w.length;
              R++
            )
              A.push(void 0 === (S = w[R]) ? S : String(S));
            var P = w.groups;
            if (x) {
              var k = [O].concat(A, T, m);
              void 0 !== P && k.push(P);
              var I = String(r.apply(void 0, k));
            } else I = u(O, m, T, A, P, r);
            T >= j && ((E += m.slice(j, T) + I), (j = T + O.length));
          }
          return E + m.slice(j);
        },
      ];
          ...
          [
            ...
            function (t, o) {
              ...
              for (var b = 0, _ = 0, w = []; _ < p.length; ) {
                ...
                if (
                  null === E ||
                  (S = g(u(x.lastIndex + (v ? 0 : _)), p.length)) === b
                )
                  _ = s(p, _, h);
                else {
  ...
  83: function (t, e, n) {
    ...
    var r = n(3),
      o = n(134).trim;
    r(
      { target: "String", proto: !0, forced: n(151)("trim") },
      {
        trim: function () {
          return o(this);
        },
